						...
						<form action="/humor/humorModifyPro.jsp" method='post' id='formHumor' name='formHumor' enctype="multipart/form-data">
							...
							<div class="mx-auto my-3" style="width: 98%">
								...
								<div class="small-10 columns">
									<input class="form-control span12" type="text" id="subject" name="subject" value="<%=humorVO.getHsubject()%>" />
								</div>

								<!-- 에디터 적용 -->
								<div class="small-10 columns" style="margin-top: 15px;">
									<textarea id="content" name="content"><%=humorVO.getHcontent()%></textarea>
								</div>
