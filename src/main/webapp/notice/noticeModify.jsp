						...
						<form action="/notice/noticeModifyPro.jsp" method='post' id='formNotice' name='formNotice' enctype="multipart/form-data">
							...
							<div class="mx-auto my-3" style="width: 98%">
								...
								<div class="small-10 columns">
									<input class="form-control span12" type="text" id="subject" name="subject" value="<%=noticeVO.getNsubject()%>" />
								</div>

								<!-- 에디터 적용 -->
								<div class="small-10 columns" style="margin-top: 15px;">
									<textarea id="content" name="content"><%=noticeVO.getNcontent()%></textarea>
								</div>
