...
<body class="bg-gray-100" id="page-top">
								...
								<div class="card-body p-0">
									...
									<div class="row">
										<div class="col-lg-12 d-none d-lg-block center-block">
											...
											<form action="/member/redactMemberPro.jsp" method="post" id="frm" name="frm" class="user">
												...
												<div class="form-group">
													...
													<div class="cols-sm-10">
														<div class="input-group">
															<input type="text" class="form-control form-control-user" name="nickname" id="nickname" value="<%=memberVO.getNickname()%>" readonly />
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="cols-sm-10">
														<div class="input-group">
															<input type="date" class="form-control form-control-user" name="birthday" id="birthday" value="<%=strBirthday%>" />
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="cols-sm-10">
														<div class="input-group">
															<input type="email" class="form-control form-control-user" name="email" id="email" value="<%=memberVO.getEmail()%>" />
														</div>
													</div>
												</div>
												...
												<button class="btn btn-secondary btn-user btn-block font-weight-bold" id="redact" type="submit">
													<span class="text mx-2">수정하기</span>
												</button>
											</form>
										</div>
									</div>
	...
	<script>
		$('button#redact').on('click', function(event) {
