			...
			<div id="content">
				...
				<div class="container-fluid" style="padding-top: 90px; padding-left: 250px;">
						...
						<div class="card-body p-0">
							<div class="row">
								<div class="col-lg-12 d-none d-lg-block center-block">
									<h3 class="font-weight-bold text-dark text-left ml-3 my-3"><a href="/board/boardList.jsp" style="text-decoration: none; color:inherit;">자유 게시판</a></h3>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card shadow mb-0">
						<input type="hidden" id="mid" name="mid" value="<%=boardVO.getMid()%>">

						<div class="text-dark mx-auto mt-4" style="width: 98%">
							<h3 class="font-weight-bold text-left"><%=boardVO.getSubject()%></h3>
							<div>
								<ul class="list" style="margin-left: -40px;">
									<li>&nbsp;<b><%=boardVO.getNick()%></b>&nbsp;
									</li>
									<li>&nbsp;<b>조회수</b>&nbsp;<%=boardVO.getReadcount()%>&nbsp;
									</li>
									<li>&nbsp;<b>작성일</b>&nbsp;<%=sdf.format(boardVO.getRegDate())%>&nbsp;
									</li>
								</ul>
							</div>
							...
							<div class="btn-toolbar my-2">
								<div class="btn-group mr-2">
									<button type="button" class="btn btn-secondary" onclick="location.href = '/board/boardList.jsp'">글목록</button>
									<%
									if (id != null) { // 로그인 확인
									%>
									<button type="button" class="btn btn-dark" onclick="location.href='/board/boardWrite.jsp'">글쓰기</button>
									<%
									}
									%>
								</div>
								...
								<%
								if (id != null) { // 로그인 확인
									if (id.equals(boardVO.getMid()) || id.equals("admin")) { // 본인 일 때만
								%>
								<div class="btn-group">
									<button type="button" class="btn btn-primary" onclick="location.href='/board/boardModify.jsp?num=<%=boardVO.getNum()%>&pageNum=<%=pageNum%>'">재등록</button>
